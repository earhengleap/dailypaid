...
export function AddTransactionModal({ onAdd, existingGroups, triggerClassName }: AddTransactionModalProps) {
  ...
  return (
    <>
      <Button 
        ...
        className={cn(
          "h-12 w-12 md:h-14 md:w-14 rounded-2xl shadow-luxury transition-all hover:scale-110 active:scale-95 bg-primary text-white z-40 haptic-active border-none flex items-center justify-center shrink-0",
          triggerClassName ?? "fixed bottom-24 right-6 md:bottom-8 md:right-8"
        )}
        size="icon"
      >
